...
public:
  ...
  virtual void SetTdmaControllerDynamic (Ptr<TdmaControllerDynamic> controller)=0;
  virtual Ptr<TdmaControllerDynamic> GetTdmaControllerDynamic (void) const=0;
  virtual void SetChannel (Ptr<SimpleWirelessChannel> channel) = 0;
  virtual void SetDevice (Ptr<TdmaNetDevice> device) = 0;
  virtual Ptr<TdmaNetDevice> GetDevice (void) const=0;
  virtual  void SetId(uint32_t id) =0;
  virtual uint32_t GetQueueSize()=0;
  virtual void StartTransmission (uint64_t transmissionTime)=0;
  virtual void StartRouteTransmission (uint64_t transmissionTime,Ptr<Packet> packet)=0;
