...
public:
   ...
   */
  void SetTdmaController (Ptr<TdmaControllerDynamic> controller);
...
private:
  ...
  Ptr<TdmaControllerDynamic> GetTdmaController (void) const;
  ...
  Ptr<TdmaControllerDynamic> m_tdmaController;
