...
TdmaNetDevice::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::TdmaNetDevice")
    ...
    .AddAttribute ("TdmaController", "The tdma controller attached to this device",
                   ...
                   MakePointerChecker<TdmaControllerDynamic> ());
  return tid;
}
...
TdmaNetDevice::CompleteConfig (void)
{
  ...
  //setup mac
  m_mac->SetTdmaControllerDynamic (m_tdmaController);
...
void
TdmaNetDevice::SetTdmaController (Ptr<TdmaControllerDynamic> controller)
{
