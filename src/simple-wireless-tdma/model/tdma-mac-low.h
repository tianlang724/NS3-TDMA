...
{
public:
  typedef Callback<void, Ptr<Packet>, const TdmaHeader*> TdmaMacLowRxCallback;
   ...
   */
  void SetRxCallback (Callback<void,Ptr<Packet>,const TdmaHeader *> callback);
  /**
...
private:
  uint32_t GetSize (Ptr<const Packet> packet, const TdmaHeader *hdr) const;
  void ForwardDown (Ptr<const Packet> packet, const TdmaHeader *hdr);
